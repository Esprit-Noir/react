      ...
      <div>
        ...
        <div className="post container">
          {articles.map(article => (
            <div className={`post-box ${article.categories[0].slug}`} key={article.id}>
              <img src="images/img1.jpg" alt="" className="post-img" />
              <h2 className="category">{article.categories[0].name}</h2>
              <a href="#" className="post-title">{article.title.rendered}</a>
